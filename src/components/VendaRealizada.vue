    ...
    <div class="flex justify-center w-full">
      <div class="flex flex-col items-center w-full md:w-9/12">
        <div class="card py-10 flex flex-col items-start px-6 w-full">
          ...
          <div
            class="py-6 w-full border border-primary grid grid-cols-2 md:flex flex-wrap gap-4 px-3 md:px-10 justify-between"
          >
          ...
          <div class="text-xs mb-2 mt-6">Dados Pessoais</div>
          <div
          ...
          >
            ...
            <div>
              <div>PIX:</div>
              <div>{{ 'taylemospj@gmail.com' }}</div>
            </div>
          </div>
          <div class="text-xs mb-2 mt-6">Dados dos Programas de Fidelidade</div>
          <div
            class="py-6 w-full border border-primary grid grid-cols-2 md:flex gap-4 px-3 md:px-10 justify-between"
          >
            <div class="text-xs md:text-sm">
              <div class="font-semibold mb-5">Cia Aérea</div>
              <div class="text-xs">
